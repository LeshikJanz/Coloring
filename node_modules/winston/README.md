...
See [log-filter-socket.js](./test/log-filter-socket.js), where card number masking is implemented as an example along with [log-rewriter-socket.js](./test/log-rewriter-socket.js)
