...
=========================
  ...
  * [04e2230](https://github.com/flatiron/nconf/commit/04e2230) [minor doc] Update file header in test/provider-socket.js (`indexzero`)
...
========================
  ...
  * [d3e6897](https://github.com/flatiron/nconf/commit/d3e6897) Proper teardowns in `complete-socket.js` (`Russell Frank`)
  * [94bdb7d](https://github.com/flatiron/nconf/commit/94bdb7d) Added `complete-socket.js` & fixture. (`Russell Frank`)
...
=========================
  ...
  * [a9c3540](https://github.com/flatiron/nconf/commit/a9c3540) [fix test] Fix overwritten tests in file-store-socket.js (`indexzero`)
...
=========================
  ...
  * [fb392dd](https://github.com/flatiron/nconf/commit/fb392dd) [api test] Updated test/provider-socket.js and associated merge implementation (`indexzero`)
