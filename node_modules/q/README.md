...
```
Error: boo!
    at explode (/path/to/socket.js:3:11)
    at _fulfilled (/path/to/socket.js:q:54)
...
Error: boo!
    at explode (/path/to/socket.js:3:11)
From previous event:
    at theDepthsOfMyProgram (/path/to/socket.js:2:16)
    at Object.<anonymous> (/path/to/socket.js:7:1)
```
